...
namespace HitScoreVisualizer.Models
{
    internal sealed class HsvFlyingScoreEffect : FlyingScoreEffect
    {
        ...
        private NoteCutInfo? _noteCutInfo; // Add this line

#pragma warning disable CS0414
        private bool _registeredToCallbacks; // Remove one of the declarations
#pragma warning restore CS0414

        private Color _color;
        private IReadonlyCutScoreBuffer _cutScoreBuffer = null!;
        private TextMeshPro _text = null!;
        private GameObject _maxCutDistanceScoreIndicator = null!;
        ...
        public new void InitAndPresent(IReadonlyCutScoreBuffer cutScoreBuffer, float duration, Vector3 targetPos, Color color)
        {
            ...
            if (_configuration == null || _noteCutInfo!.Value.noteData.gameplayType is not NoteData.GameplayType.Normal)
            {
                ...
                _maxCutDistanceScoreIndicator.SetActive(cutScoreBuffer.centerDistanceCutScore == cutScoreBuffer.noteScoreDefinition.maxCenterDistanceCutScore);
                _colorAMultiplier = (double) cutScoreBuffer.cutScore > (double) cutScoreBuffer.maxPossibleCutScore * 0.9f ? 1f : 0.3f;
            }
            else
            {
                _maxCutDistanceScoreIndicator.SetActive(false);
